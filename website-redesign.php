        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div>
                ...
                <p class="text-base sm:text-lg md:text-xl text-gray-400 leading-8 md:leading-10">
                    ...
                    Anprix Solutions is a leading website redesign agency in Ahmedabad, Gujarat, India, helping businesses transform outdated websites into modern, high-performing digital assets. Our website redesign services focus on improving user experience, enhancing visual appeal, increasing website speed, optimizing for search engines, and driving higher conversions.
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div class="text-center mb-14 md:mb-20">
            ...
            <p class="text-gray-400 text-base md:text-lg max-w-3xl mx-auto leading-8 md:leading-9">
                An outdated website can negatively impact your brand image, reduce user engagement, and limit your ability to generate leads and sales.
            </p>
...
<!-- WHY CHOOSE ANPRIX FOR REDESIGN -->
<section class="py-16 md:py-24 section-border overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div class="text-center mb-14 md:mb-20">
            ...
            <p class="text-gray-400 text-base md:text-lg max-w-3xl mx-auto leading-8 md:leading-9">
                As one of the trusted website redesign companies in Ahmedabad, we understand that a successful redesign goes beyond aesthetics. It involves strategic planning, user behavior analysis, technical optimization, and conversion-focused design.
            </p>
        ...
        <div class="glass-card rounded-[28px] md:rounded-[50px] p-8 sm:p-12 md:p-16 text-center relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <p class="text-gray-400 text-base sm:text-lg md:text-xl leading-8 md:leading-9 max-w-3xl mx-auto mb-10">
                    Whether you are a startup, healthcare clinic, jewelry business, restaurant, educational institute, real estate company, manufacturer, or corporate organization, our team provides customized redesign solutions that align with your business goals.
                </p>
